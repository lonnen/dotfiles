(function() {
  var AtomReact, autoCompleteTagCloseRegex, autoCompleteTagStartRegex, contentCheckRegex, defaultDetectReactFilePattern;
  ...
  AtomReact = (function() {
    ...
    AtomReact.prototype.autoCloseTag = function(eventObj, editor) {
      var fullLine, lastCharIndex, lastLine, lastLineSpaces, line, lines, match, rest, row, serializedEndPoint, tagName, token;
      if (!this.isReactEnabledForEditor(editor)) {
        return;
      }
      if ((eventObj != null ? eventObj.newText : void 0) === '>' && !eventObj.oldText) {
        ...
        if ((row == null) || lastCharIndex < 0 || lastCharIndex > fullLine.length - 1) {
          return;
        }
    ...
    AtomReact.prototype.processEditor = function(editor) {
      ...
      return this.disposables.push(disposableBufferEvent);
    };
    ...
    AtomReact.prototype.activate = function() {
      var decreaseIndentForNextLinePattern, disposableConfigListener, disposableHTMLTOJSX, disposableProcessEditor, disposableReformat, jsxComplexAttributePattern, jsxTagStartPattern;
      this.disposables = [];
      ...
      this.disposables.push(disposableConfigListener);
      this.disposables.push(disposableReformat);
      this.disposables.push(disposableHTMLTOJSX);
      return this.disposables.push(disposableProcessEditor);
    };
